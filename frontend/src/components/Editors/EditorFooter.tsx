...
function EditorFooter() {
    ...
    const handleClearResultClicked = () => {
        tabStore.getState().updateDataById(activeTabId as string, {loading: false, generatedText: null, error: undefined, logId: undefined})
    };
        ...
        <div>
            ...
            <div className="pg-content-footer">
                <div className="pg-footer-left">
                    <FooterSubmitButton data={data} activeTabId={activeTabId} generateResultForPrompt={generateResultForPrompt}/>
                    <PlaygroundButton
                        text="Save"
                        id="save-prompt"
