...
const ModelSettings = ({
    ...
    return (
        <div className="w-3/4">
          ...
          <ModelSettingsOptions selectedModel={selectedModel} updateModel={updateModel} />
          ...
          <div className="m-2 mt-4">
            ...
            <ModelAPISettings api={api} testAPI={testAPI} selectedModel={selectedModel} apiResponse={apiResponse} setApiResponse={setApiResponse} style={style} setFormattedApi={setFormattedApi} generate_pre_compontent={generate_pre_compontent} />

            {inputFormat != undefined ? <>
              <ModelInputFormatSettings api={api} testAPI={testAPI} selectedModel={selectedModel} inputFormat={inputFormat} setInputFormat={setInputFormat} inputFormatResponse={inputFormatResponse} setInputFormatResponse={setInputFormatResponse} style={style} generate_pre_compontent={generate_pre_compontent} />
              <ModelOutputFormatSettings api={api} testAPI={testAPI} selectedModel={selectedModel} inputFormat={inputFormat} outputFormat={outputFormat} setOutputFormat={setOutputFormat} outputFormatResponse={outputFormatResponse} setOutputFormatResponse={setOutputFormatResponse} style={style} generate_pre_compontent={generate_pre_compontent} />
            </> : <>
