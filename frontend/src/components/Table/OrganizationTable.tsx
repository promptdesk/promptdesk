...
const OrganizationTable: React.FC<OrganizationTableProps> = ({ organization }) => {
  return (
      ...
      <tbody className="divide-y divide-gray-200">
        {organization?.keys.map((variable, index) => (
          <tr key={index}>
            ...
            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{variable.description}</td>
